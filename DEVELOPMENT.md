...
```bash
git remote add encore encore://planly-productivity-app-3ed2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/planly-productivity-app-3ed2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/planly-productivity-app-3ed2/settings/integrations/github)
